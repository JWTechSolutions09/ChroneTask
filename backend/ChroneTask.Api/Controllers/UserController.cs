...
public class UserController : ControllerBase
{
    ...
    // ========== COMENTARIOS DE PROYECTOS PERSONALES ==========

    // GET: api/users/me/projects/{id}/comments
    [HttpGet("me/projects/{id:guid}/comments")]
    public async Task<ActionResult<List<ProjectCommentResponse>>> GetPersonalProjectComments(Guid id)
    {
        try
        {
            var userId = UserContext.GetUserId(User);
        ...
        {
            Console.WriteLine($"❌ Error en GetPersonalProjectComments: {ex.Message}");
            return StatusCode(500, new
            {
                error = "Internal Server Error",
                message = ex.Message
    ...
    // POST: api/users/me/projects/{id}/comments
    [HttpPost("me/projects/{id:guid}/comments")]
    public async Task<ActionResult<ProjectCommentResponse>> CreatePersonalProjectComment(Guid id, [FromBody] ProjectCommentCreateRequest request)
    {
        try
        {
            var userId = UserContext.GetUserId(User);
            ...
            await NotificationHelper.NotifyNewProjectCommentAsync(_db, comment, id, userId);
        ...
        {
            Console.WriteLine($"❌ Error en CreatePersonalProjectComment: {ex.Message}");
            return StatusCode(500, new
            {
                error = "Internal Server Error",
                message = ex.Message
    ...
    // PATCH: api/users/me/projects/{id}/comments/{commentId}
    [HttpPatch("me/projects/{id:guid}/comments/{commentId:guid}")]
    public async Task<ActionResult<ProjectCommentResponse>> UpdatePersonalProjectComment(Guid id, Guid commentId, [FromBody] ProjectCommentCreateRequest request)
    {
        try
        {
            var userId = UserContext.GetUserId(User);
            ...
            var comment = await _db.ProjectComments
                .Include(c => c.User)
                .Include(c => c.Attachments)
                .FirstOrDefaultAsync(c => c.Id == commentId && c.ProjectId == id);
        ...
        {
            Console.WriteLine($"❌ Error en UpdatePersonalProjectComment: {ex.Message}");
            return StatusCode(500, new
            {
                error = "Internal Server Error",
                message = ex.Message
    ...
    // DELETE: api/users/me/projects/{id}/comments/{commentId}
    [HttpDelete("me/projects/{id:guid}/comments/{commentId:guid}")]
    public async Task<IActionResult> DeletePersonalProjectComment(Guid id, Guid commentId)
    {
        try
        {
            var userId = UserContext.GetUserId(User);
        ...
        {
            Console.WriteLine($"❌ Error en DeletePersonalProjectComment: {ex.Message}");
            return StatusCode(500, new
            {
                error = "Internal Server Error",
                message = ex.Message
